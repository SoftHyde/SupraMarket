/* /////////////////////////////////////////////////////////////////////////
 * File:        vole/object/generated/put_properties.hpp
 *
...
{
  varx_type var0(a0);
  this->Invoke(propId, DISPATCH_PROPERTYPUT, &var0, 1);
}

template <typename T0>
inline void put_property(LPCOLESTR propName, T0 const &a0)
{
  put_property(GetIDOfName(propName), a0);
}
...
void put_property(DISPID propId, T0 const &a0, T1 const &a1)
{
  ...
  this->Invoke(propId, DISPATCH_PROPERTYPUT, &vars[0], STLSOFT_NUM_ELEMENTS(vars));
}

template <typename T0, typename T1>
inline void put_property(LPCOLESTR propName, T0 const &a0, T1 const &a1)
{
  put_property(GetIDOfName(propName), a0, a1);
}
...
{
  put_property(GetIDOfName(propName), a0, a1, a2);
}
...
{
  put_property(GetIDOfName(propName), a0, a1, a2, a3);
}
