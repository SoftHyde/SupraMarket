/* /////////////////////////////////////////////////////////////////////////
 * File:        vole/object/generated/get_properties.hpp
 *
 * Generated:   17th January 2007
 *
...
R get_property(of_type<R>, DISPID propId) const
{
  ...
  this->Invoke(propId, DISPATCH_PROPERTYGET, result);
...
{
  return get_property(of_type<R>(), GetIDOfName(propName));
}
...
R get_property(of_type<R>, DISPID propId, T0 const &a0) const
{
  ...
  ::VariantInit(&result);
  stlsoft::scoped_handle<VARIANT*>  result_(&result, ::VariantClear);
  this->Invoke(propId, DISPATCH_PROPERTYGET, &var0, 1, result);
  return return_traits_t::convert(result, m_coercionLevel);
}
...
{
  return get_property(of_type<R>(), GetIDOfName(propName), a0);
}
...
R get_property(of_type<R>, DISPID propId, T0 const &a0, T1 const &a1) const
{
  ...
  this->Invoke(propId, DISPATCH_PROPERTYGET, &vars[0], STLSOFT_NUM_ELEMENTS(vars), result);
  return return_traits_t::convert(result, m_coercionLevel);
}
...
{
  return get_property(of_type<R>(), GetIDOfName(propName), a0, a1);
}
...
{
  return get_property(of_type<R>(), GetIDOfName(propName), a0, a1, a2);
}
...
{
  return get_property(of_type<R>(), GetIDOfName(propName), a0, a1, a2, a3);
}
