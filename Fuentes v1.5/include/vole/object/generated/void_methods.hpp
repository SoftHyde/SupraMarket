/* /////////////////////////////////////////////////////////////////////////
 * File:        vole/object/generated/void_methods.hpp
 *
...
{
  invoke_method_impl_v(methodName, NULL, 0);
}


void invoke_method_v(DISPID methodId)
{
  invoke_method_impl_v(methodId, NULL, 0);
}
...
{
  varx_type var0(a0);
  invoke_method_impl_v(methodName, &var0, 1);
}
...
{
  varx_type var0(a0);
  invoke_method_impl_v(methodId, &var0, 1);
}
...
void invoke_method_v(LPCOLESTR methodName, T0 const &a0, T1 const &a1)
{
  ...
  invoke_method_impl_v(methodName, &vars[0], STLSOFT_NUM_ELEMENTS(vars));
}
...
void invoke_method_v(DISPID methodId, T0 const &a0, T1 const &a1)
{
  ...
  varx_type(a0).swap(vars[1]);
  varx_type(a1).swap(vars[0]);
  invoke_method_impl_v(methodId, &vars[0], STLSOFT_NUM_ELEMENTS(vars));
}
